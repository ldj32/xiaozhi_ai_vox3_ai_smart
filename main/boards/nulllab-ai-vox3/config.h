...
#define VOLUME_UP_BUTTON_EN_INVERT false
#define VOLUME_DOWN_BUTTON_EN_INVERT false
...
#define DEVICE_UART_NUM UART_NUM_2
#define DEVICE_UART_TX_PIN GPIO_NUM_5
#define DEVICE_UART_RX_PIN GPIO_NUM_6
