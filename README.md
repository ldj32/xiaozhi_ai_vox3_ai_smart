...
- 增加可自定义热点名称的选项 `CONFIG_CUSTOM_SSID_PREFIX="AI-VOX"`（修改位置：开发板 `main/boards/nulllab-ai-vox-v3/config.json` 的 `sdkconfig_append`，或 `idf.py menuconfig` → `WiFi Configuration Method` → `Custom SSID Prefix`）
